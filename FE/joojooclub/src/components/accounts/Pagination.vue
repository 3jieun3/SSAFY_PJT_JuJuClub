<template>
	<div>
		<nav class="pagination-outer">
			<ul class="pagination">
				<li class="page-item">
					<a class="page-link" @click="goPage(currentPage - 1)" v-if="!(currentPage === myPageList.at(0))">
						<span>«</span>
					</a>
				</li>
				...
				<li class="page-item">
					<a class="page-link" @click="goPage(currentPage + 1)" v-if="!(currentPage === myPageList.at(-1))">
						<span>»</span>
					</a>
				</li>
			</ul>
