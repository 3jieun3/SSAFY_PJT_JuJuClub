...
public class FeedController {
    ...
    @PostMapping("/valid")
    public ResponseEntity<Map<String, String>> registReview( @ApiParam(value = "필요한 정보(title, content, drinkIndex, customTags, imgFile)",required = true) RegistFeed registFeed , MultipartFile imgFile,  HttpServletRequest request) throws IOException {
